...
class SKY_MEDIA_EXPORT WBackendVlcShader : public QSGMaterialShader
{
...
class SKY_MEDIA_EXPORT WBackendVlcMaterial : public QSGMaterial
{
public:
    WBackendVlcMaterial();
...
class SKY_MEDIA_EXPORT WBackendVlcNode : public WBackendNode
{
public:
    WBackendVlcNode();
...
class SKY_MEDIA_EXPORT WBackendVlcPrivate : public WAbstractBackendPrivate
{
public: // Enums
    enum EventType
    {
