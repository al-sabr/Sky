...
class SKY_GUI_EXPORT WDeclarativeBordersLine : public QSGGeometryNode
{
public:
...
class SKY_GUI_EXPORT WDeclarativeBordersNode : public QSGNode
{
public:
    WDeclarativeBordersNode();
...
#ifdef SK_SOFTWARE
class SKY_GUI_EXPORT WDeclarativeBordersPrivate : public WDeclarativeItemPaintPrivate
#else
class SKY_GUI_EXPORT WDeclarativeBordersPrivate : public WDeclarativeItemPrivate
#endif
{
public:
