...
class SKY_GUI_EXPORT WLibraryFolderItem
{
public:
...
class SKY_GUI_EXPORT WLibraryFolderWatcher
{
protected:
...
class SKY_GUI_EXPORT WLibraryFolder : public WLibraryItem
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WLibraryFolderSearch : public WLibraryFolder
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WLibraryFolderSearchable : public WLibraryFolder
{
    Q_OBJECT
