...
class SKY_GUI_EXPORT WBackendNode : public QSGGeometryNode
{
public:
    WBackendNode();
...
class SKY_GUI_EXPORT WBackendInterface
{
public:
...
class SKY_GUI_EXPORT WAbstractBackend : public QObject, public WBackendInterface, public WPrivatable
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WBackendFilter
{
public:
