...
class SKY_GUI_EXPORT WPlaylistWatcher
{
protected:
...
class SKY_GUI_EXPORT WPlaylist : public WLibraryItem
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WPlaylistFeed : public WPlaylist
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WPlaylistSearch : public WPlaylist
{
    Q_OBJECT
