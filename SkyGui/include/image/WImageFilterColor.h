...
class SKY_GUI_EXPORT WDeclarativeGradientStop : public QObject
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WDeclarativeGradient : public QObject
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WImageFilterColor : public WImageFilter
{
    Q_OBJECT
