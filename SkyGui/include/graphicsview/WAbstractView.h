...
#ifdef QT_4
class SKY_GUI_EXPORT WAbstractView : public QDeclarativeView, public WPrivatable
#else
class SKY_GUI_EXPORT WAbstractView : public QQuickWindow, public WPrivatable
#endif
{
    Q_OBJECT
