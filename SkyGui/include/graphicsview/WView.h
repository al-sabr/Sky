...
class SKY_GUI_EXPORT WDeclarativeKeyEvent : public QObject
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WDeclarativeDropEvent : public QObject
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WView : public WAbstractView
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WViewScene : public QGraphicsScene
{
    Q_OBJECT
