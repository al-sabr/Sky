...
class SKY_GUI_EXPORT WModelLibraryFolder : public QAbstractListModel, public WLibraryFolderWatcher,
                                          public WPrivatable
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WModelLibraryFolderFiltered : public QSortFilterProxyModel, public WPrivatable
{
    Q_OBJECT
