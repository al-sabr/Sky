...
#ifdef QT_4
class SKY_GUI_EXPORT WDeclarativeTextSvg : public WDeclarativeItem
#else
class SKY_GUI_EXPORT WDeclarativeTextSvg : public WDeclarativeTexture
#endif
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WDeclarativeTextSvgScale : public WDeclarativeTextSvg
{
    Q_OBJECT
