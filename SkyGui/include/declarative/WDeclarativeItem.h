...
#ifdef QT_4
class SKY_GUI_EXPORT WDeclarativeItem : public QDeclarativeItem, public WPrivatable
#else
class SKY_GUI_EXPORT WDeclarativeItem : public QQuickItem, public WPrivatable
#endif
{
    Q_OBJECT
