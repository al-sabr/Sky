...
#ifdef SK_SOFTWARE
class SKY_GUI_EXPORT WDeclarativePlayer : public WDeclarativeItemPaint, public WPlaylistWatcher
#else
class SKY_GUI_EXPORT WDeclarativePlayer : public WDeclarativeItem, public WPlaylistWatcher
#endif
{
    Q_OBJECT
