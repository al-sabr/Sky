...
#ifdef QT_4
class SKY_GUI_EXPORT WDeclarativeImageSvgPrivate : public WDeclarativeItemPrivate
#else
class SKY_GUI_EXPORT WDeclarativeImageSvgPrivate : public WDeclarativeTexturePrivate
#endif
{
public:
...
class SKY_GUI_EXPORT WDeclarativeImageSvgScalePrivate : public WDeclarativeImageSvgPrivate
{
public:
