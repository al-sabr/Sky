...
class SKY_GUI_EXPORT WDeclarativeMouseEvent : public QObject
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WDeclarativeDrag : public QObject
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WDeclarativeMouseArea : public WDeclarativeItem
{
    Q_OBJECT
