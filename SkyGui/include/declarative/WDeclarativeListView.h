...
class SKY_GUI_EXPORT WDeclarativeListView : public WDeclarativeItem
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WDeclarativeListHorizontal : public WDeclarativeListView
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WDeclarativeListVertical : public WDeclarativeListView
{
    Q_OBJECT
