...
class SKY_GUI_EXPORT WDeclarativeBorderGrid : public QObject
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WDeclarativeBorderImage : public WDeclarativeImageBase
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WDeclarativeBorderImageScale : public WDeclarativeBorderImage
{
    Q_OBJECT
