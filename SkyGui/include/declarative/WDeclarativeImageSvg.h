...
#ifdef QT_4
class SKY_GUI_EXPORT WDeclarativeImageSvg : public WDeclarativeItem
#else
class SKY_GUI_EXPORT WDeclarativeImageSvg : public WDeclarativeTexture
#endif
{
    Q_OBJECT
...
class SKY_GUI_EXPORT WDeclarativeImageSvgScale : public WDeclarativeImageSvg
{
    Q_OBJECT
