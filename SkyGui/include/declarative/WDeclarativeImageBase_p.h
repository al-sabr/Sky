...
#ifdef QT_4
class SKY_GUI_EXPORT WDeclarativeImageBasePrivate : public WDeclarativeItemPrivate
#else
class SKY_GUI_EXPORT WDeclarativeImageBasePrivate : public WDeclarativeTexturePrivate
#endif
{
public:
