...
class SKY_BACKEND_EXPORT WBackendUniversalNode
{
public: // Enums
    enum Type
    {
...
class SKY_BACKEND_EXPORT WBackendUniversalScript
{
public:
...
class SKY_BACKEND_EXPORT WBackendUniversalParameters
{
public:
...
class SKY_BACKEND_EXPORT WBackendUniversalPrivate : public WBackendNetPrivate
{
public:
