...
#ifndef WBACKENDLASTFM_H
#define WBACKENDLASTFM_H
...
class WBackendLastFmPrivate;

class SKY_BACKEND_EXPORT WBackendLastFm : public WBackendNet
{
    Q_OBJECT
...
private:
    W_DECLARE_PRIVATE(WBackendLastFm)
};

#endif // SK_NO_BACKENDLASTFM
#endif // WBACKENDLASTFM_H
