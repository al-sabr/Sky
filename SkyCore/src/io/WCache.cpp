...
class SKY_CORE_EXPORT WCacheThread : public QThread
{
    Q_OBJECT
...
class SKY_CORE_EXPORT WCacheThreadEventFile : public QEvent
{
public:
...
class SKY_CORE_EXPORT WCacheThreadEventWrite : public QEvent
{
public:
...
class SKY_CORE_EXPORT WCacheThreadEventUrls : public QEvent
{
public:
...
class SKY_CORE_EXPORT WCacheThreadEventProxy : public QEvent
{
public:
...
class SKY_CORE_EXPORT WCacheThreadEvent : public QEvent
{
public:
...
class SKY_CORE_EXPORT WCacheEventUrls : public QEvent
{
public:
...
class SKY_CORE_EXPORT WCacheEventAdded : public QEvent
{
public:
...
class SKY_CORE_EXPORT WCacheEventFailed : public QEvent
{
public:
...
class SKY_CORE_EXPORT WCacheFileDelete : public WControllerFileAction
{
    Q_OBJECT
